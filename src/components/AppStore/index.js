...
class AppStore extends Component {
  ...
  getFilteredAppsList = () => {
    ...
    const searchedFilteredList = filteredAppsList.filter(eachItem =>
      eachItem.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )

    const finalFilteredAppsList =
      searchInput === '' ? filteredAppsList : searchedFilteredList

    return finalFilteredAppsList
  }

  render() {
    const {activeTabId} = this.state

    const finalFilteredAppsList = this.getFilteredAppsList()
    console.log(finalFilteredAppsList)
      ...
      <div className="app-container">
        <div className="app-store-container">
          ...
          <ul className="apps-container">
            {finalFilteredAppsList.map(eachItem => (
